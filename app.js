...
mongoose.set("strictQuery", true); //to suppress warning in command line.
mongoose.connect(
  "mongodb+srv://rafaeldariusk:bird1635@mycluster.e4xbiot.mongodb.net/travels"
);
...
// in multer we create object {} where to save images
